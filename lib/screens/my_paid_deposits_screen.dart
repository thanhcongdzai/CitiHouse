...
class MyPaidDepositsScreen extends StatefulWidget {
  final String userId;

  const MyPaidDepositsScreen({super.key, required this.userId});

  @override
  State<MyPaidDepositsScreen> createState() => _MyPaidDepositsScreenState();
}

class _MyPaidDepositsScreenState extends State<MyPaidDepositsScreen> {
  ...
  Future<void> _fetchOrders() async {
    ...
    try {
      ...
      final paidOrders = allOrders.where((o) => o['status'] == 'Da thanh toan').toList();
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Các đơn cọc đã thanh toán sẽ hiển thị ở đây',
                            style: TextStyle(
                              fontSize: 14,
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => MyDepositOrderDetailScreen(order: order),
                                    ),
                                  ).then((_) => _fetchOrders());
                                },
                                child: Padding(
